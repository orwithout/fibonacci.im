...
<script>
	...
	// 从 url 中获取参数
	// 示例: http://localhost:5173/?a00==http://127.0.0.1:8002/0/a00?v1=x&v2=y|tag1;http://127.0.0.1:8002/0/a01|tag2;;a02==http://127.0.0.1:8002/0/a01;;infoBase=={"k1":["v1","v2"],"k2":["v2"]}
